          ...
          <CardContent>
            <form className="space-y-5">
              ...
              <div className="space-y-2">
                ...
                <select id="subject" className="h-11 w-full rounded-md border bg-background px-3 text-sm text-muted-foreground">
              ...
              <div className="space-y-2">
                ...
                <Textarea id="message" placeholder="Please describe your issue or question in detail..." className="min-h-36" />
              </div>
  ...
  return (
    <Card>
      <CardContent className="p-6 text-center">
        <div className="mx-auto mb-3 flex h-10 w-10 items-center justify-center rounded-lg bg-primary/10 text-primary">{icon}</div>
